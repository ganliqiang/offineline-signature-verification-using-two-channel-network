...
#        self.image_dir = '/home/' + usr + '/Workspace/SignatureVerification/Datasets/' + dataset + '/'
        self.image_dir = '/mnt/data/gandata/signet/' + dataset + '/'
        data_file = self.image_dir + 'new1' + '.txt'
        ...
        self.input_shape=(self.height, self.width, 2)
        ...
        while True:
            ...
            for line in lines:
               ...
               #image_pairs += [[img1, img2]]
                image_pairs.append(np.concatenate((img1,img2),2))
    ...
    def fit(self, x, augment=False, rounds=1, seed=None):
        ...
        if x.shape[self.channel_axis] not in {1, 3, 4,2}:
            raise ValueError(
